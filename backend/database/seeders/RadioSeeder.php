...
class RadioSeeder extends Seeder
{
    ...
    {
        $cdnUrl = rtrim((string) env('CLOUDFLARE_R2_URL', ''), '/');

        if (app()->environment('production') && $cdnUrl === '') {
            throw new \RuntimeException('CLOUDFLARE_R2_URL precisa ser configurada em produção.');
        }

        $cdnUrl = $cdnUrl ?: rtrim((string) env('APP_URL', 'http://localhost:8000'), '/');

        // 1. Criar Artistas
        $artist1 = Artist::updateOrCreate(['name' => 'Lucas Lazari'], [
            'name' => 'Lucas Lazari',
        ...
        $artist2 = Artist::updateOrCreate(['name' => 'Neon Dreams'], [
            'name' => 'Neon Dreams',
            'avatar_url' => 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150&auto=format&fit=crop&q=80',
            'social_link' => 'https://spotify.com',
        ]);

        $artist3 = Artist::updateOrCreate(['name' => 'Silva & Bossa'], [
            'name' => 'Silva & Bossa',
            'avatar_url' => 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=150&auto=format&fit=crop&q=80',
            'social_link' => 'https://instagram.com',
        ]);

        $artist4 = Artist::updateOrCreate(['name' => 'Velvet Moon'], [
            'name' => 'Velvet Moon',
        ...
        $stationLofi = Station::updateOrCreate(['slug' => 'lofi-chill'], [
        ...
        $stationVaporwave = Station::updateOrCreate(['slug' => 'vaporwave'], [
        ...
        $stationBossa = Station::updateOrCreate(['slug' => 'lofi-br'], [
        ...
        $stationRnb = Station::updateOrCreate(['slug' => 'midnight-rnb'], [
            'name' => 'Midnight R&B',
            'slug' => 'midnight-rnb',
        ...
        Track::updateOrCreate(['audio_url' => "{$cdnUrl}/audio/Lucas%20Lazari%20-%20New%20Wings.mp3"], [
        ...
        Track::updateOrCreate(['audio_url' => "{$cdnUrl}/audio/us%20-%20cat%20naps.mp3"], [
            'station_id' => $stationLofi->id,
            'artist_id' => $artist1->id,
            'title' => 'Cat Naps',
        ...
        // Estação: Vaporwave
        Track::updateOrCreate(['audio_url' => 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-3.mp3'], [
        ...
        Track::updateOrCreate(['audio_url' => 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-4.mp3'], [
            'station_id' => $stationVaporwave->id,
            'artist_id' => $artist2->id,
        ...
        // Estação: Lo-Fi Bossa
        Track::updateOrCreate(['audio_url' => 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-5.mp3'], [
        ...
        Track::updateOrCreate(['audio_url' => 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-6.mp3'], [
